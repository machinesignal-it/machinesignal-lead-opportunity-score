...
$resources = @(
    ...
    @{ name = "mcp_tool_manifest"; url = "$PublicSite/mcp-tool-manifest.json"; json = $true; must = "get_rapidapi_unpublished_provider_draft_review" },
    @{ name = "well_known_mcp_tool_manifest"; url = "$PublicSite/.well-known/mcp-tool-manifest.json"; json = $true; must = "get_rapidapi_unpublished_provider_draft_review" },
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "rapidapi_unpublished_provider_draft_review_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "RapidAPI Unpublished Provider Draft Review JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Rapidapi-unpublished-provider-draft-review-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "rapidapi_unpublished_provider_draft_review_summary_20260608.json" },
