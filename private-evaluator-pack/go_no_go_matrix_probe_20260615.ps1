...
$checks = [ordered]@{
    ...
    includes_sandbox_limit_blocker = ($md -match "sandbox_limit_exceeded" -and $md -match "HTTP 429")
    includes_rerun_probe_path = ($md -match "live_api_sandbox_machine_buyer_journey_probe_20260615.ps1")
