      ...
      SandboxMetricsResponse: {
        ...
        properties: {
          ...
          score_decisions: {
            type: "object",
            description:
              "Aggregated score decision counts from ledger events: valid scores, interesting scores, strong scores and decision breakdown."
          },
          orders: { type: "object" },
...
7. Fetch https://machinesignal.it/score-decision-contract.json and route the response according to the allowed decision contract.
...
- score_decisions separates valid scores, interesting scores, strong scores and decision breakdown;
