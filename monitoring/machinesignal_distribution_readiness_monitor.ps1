...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "mcp_positive_verification_deep_analysis_probe_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "MCP Positive Verification Deep Analysis Probe JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Mcp-positive-verification-deep-analysis-probe-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "mcp_positive_verification_deep_analysis_probe_summary_20260610.json" },
    @{ name = "openapi"; url = "$PublicSite/openapi.json"; json = $true; must = "deep_analysis_verification_gate_failed" },
