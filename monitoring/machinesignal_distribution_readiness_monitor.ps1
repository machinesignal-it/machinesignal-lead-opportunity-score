...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "API Directory Private Listing Sandbox Rehearsal JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Api-directory-private-listing-sandbox-rehearsal-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "api_directory_private_listing_sandbox_rehearsal_summary_20260611.json" },
