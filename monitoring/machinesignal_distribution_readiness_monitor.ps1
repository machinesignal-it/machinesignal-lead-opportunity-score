...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "sandbox_only_external_publication_pack_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Sandbox-Only External Publication Pack JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Sandbox-only-external-publication-pack-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "sandbox_only_external_publication_pack_20260607.json" },
