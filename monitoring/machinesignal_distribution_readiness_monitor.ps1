...
$resources = @(
    ...
    @{ name = "mcp_tool_manifest"; url = "$PublicSite/mcp-tool-manifest.json"; json = $true; must = "get_machine_deep_analysis_single_purchase_proof" },
    @{ name = "well_known_mcp_tool_manifest"; url = "$PublicSite/.well-known/mcp-tool-manifest.json"; json = $true; must = "get_machine_deep_analysis_single_purchase_proof" },
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "machine_deep_analysis_single_purchase_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Machine Deep Analysis Single Purchase JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Machine-deep-analysis-single-purchase-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "machine_deep_analysis_single_purchase_summary_20260608.json" },
