...
const resources = [
  ...
  {
    name: "rapidapi_unpublished_provider_draft_review_md",
    url: `${publicSite}/rapidapi_unpublished_provider_draft_review_report_20260608.md`,
    json: false,
    must: [
      "RapidAPI-Style Unpublished Provider Draft Review",
      "External publication executed: false",
  ...
  {
    name: "rapidapi_unpublished_provider_draft_review_json",
    url: `${publicSite}/rapidapi_unpublished_provider_draft_review_summary_20260608.json`,
    json: true,
    must: [
      "completed_rapidapi_unpublished_provider_draft_review",
      "NoWriteRapidApiUnpublishedProviderDraftReview",
      "rapidapi_unpublished_provider_draft_ready",
      "required_fields_checked"
    ]
  },
  {
