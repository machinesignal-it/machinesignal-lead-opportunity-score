...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "machine_public_discovery_nowrite_simulation_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Machine Public Discovery NoWrite Simulation JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Machine-public-discovery-nowrite-simulation-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "machine_public_discovery_nowrite_simulation_summary_20260610.json" },
