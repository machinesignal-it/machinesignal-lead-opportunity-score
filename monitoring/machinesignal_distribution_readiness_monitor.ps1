...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "machine_discovery_full_simulation_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Machine Discovery Full Simulation JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Machine-discovery-full-simulation-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "machine_discovery_full_simulation_summary_20260607.json" },
