...
| score_delta_expected | OK | delta=300 |
| purchase_failures_zero | OK | failures=0 |
| deep_analysis_delta_expected | OK | delta=100, purchases=100 |
| verification_delta_expected | OK | delta=140, purchases=140 |
