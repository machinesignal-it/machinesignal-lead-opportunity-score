...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Postman Private Team Workspace Sandbox Rehearsal JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Postman-private-team-workspace-sandbox-rehearsal-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "postman_private_team_workspace_sandbox_rehearsal_summary_20260611.json" },
