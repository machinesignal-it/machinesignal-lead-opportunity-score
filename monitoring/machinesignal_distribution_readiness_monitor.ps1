...
$resources = @(
    ...
    @{ name = "postman_private_team_workspace_setup_md"; url = "$PublicSite/postman_private_team_workspace_setup_report_20260611.md"; json = $false; must = "Postman Private Team Workspace Setup" },
    @{ name = "postman_private_team_workspace_setup_json"; url = "$PublicSite/postman_private_team_workspace_setup_summary_20260611.json"; json = $true; must = "completed_postman_private_team_workspace_setup" },
    @{ name = "postman_private_team_workspace_sandbox_rehearsal_md"; url = "$PublicSite/postman_private_team_workspace_sandbox_rehearsal_report_20260611.md"; json = $false; must = "Postman Private Team Workspace Sandbox Rehearsal" },
    @{ name = "postman_private_team_workspace_sandbox_rehearsal_json"; url = "$PublicSite/postman_private_team_workspace_sandbox_rehearsal_summary_20260611.json"; json = $true; must = "completed_postman_private_team_workspace_sandbox_rehearsal" },
    @{ name = "api_directory_private_listing_sandbox_rehearsal_md"; url = "$PublicSite/api_directory_private_listing_sandbox_rehearsal_report_20260611.md"; json = $false; must = "API Directory Private Listing Sandbox Rehearsal" },
    @{ name = "api_directory_private_listing_sandbox_rehearsal_json"; url = "$PublicSite/api_directory_private_listing_sandbox_rehearsal_summary_20260611.json"; json = $true; must = "completed_api_directory_private_listing_sandbox_rehearsal" },
    @{ name = "agent_go_no_go_postman_api_directory_review_md"; url = "$PublicSite/agent_go_no_go_postman_api_directory_review_20260611.md"; json = $false; must = "MachineSignal Agent Go/No-Go Postman and API Directory Review" },
    @{ name = "agent_go_no_go_postman_api_directory_review_json"; url = "$PublicSite/agent_go_no_go_postman_api_directory_review_summary_20260611.json"; json = $true; must = "completed_agent_go_no_go_postman_api_directory_review" },
    @{ name = "rapidapi_unpublished_provider_sandbox_rehearsal_md"; url = "$PublicSite/rapidapi_unpublished_provider_sandbox_rehearsal_report_20260611.md"; json = $false; must = "RapidAPI-Style Unpublished Provider Sandbox Rehearsal" },
    @{ name = "rapidapi_unpublished_provider_sandbox_rehearsal_json"; url = "$PublicSite/rapidapi_unpublished_provider_sandbox_rehearsal_summary_20260611.json"; json = $true; must = "completed_rapidapi_unpublished_provider_sandbox_rehearsal" },
    @{ name = "agent_go_no_go_private_external_evaluator_review_md"; url = "$PublicSite/agent_go_no_go_private_external_evaluator_review_20260611.md"; json = $false; must = "MachineSignal Agent Go/No-Go Private External Evaluator Review" },
    @{ name = "agent_go_no_go_private_external_evaluator_review_json"; url = "$PublicSite/agent_go_no_go_private_external_evaluator_review_summary_20260611.json"; json = $true; must = "completed_agent_go_no_go_private_external_evaluator_review" },
    @{ name = "private_external_evaluator_access_simulated_nowrite_md"; url = "$PublicSite/private_external_evaluator_access_simulated_nowrite_report_20260611.md"; json = $false; must = "Private External Evaluator Access Simulated NoWrite" },
    @{ name = "private_external_evaluator_access_simulated_nowrite_json"; url = "$PublicSite/private_external_evaluator_access_simulated_nowrite_summary_20260611.json"; json = $true; must = "completed_private_external_evaluator_access_simulated_no_write" },
    ...
    @{ name = "mcp_agent_registry_draft_rehearsal_nowrite_probe_md"; url = "$PublicSite/mcp_agent_registry_draft_rehearsal_nowrite_probe_report_20260611.md"; json = $false; must = "MCP Agent Registry Draft Rehearsal NoWrite Probe" },
    ...
    @{ name = "sandbox_external_draft_distribution_readiness_review_md"; url = "$PublicSite/sandbox_external_draft_distribution_readiness_review_report_20260611.md"; json = $false; must = "MachineSignal Sandbox External Draft Distribution Readiness Review" },
    @{ name = "sandbox_external_draft_distribution_readiness_review_json"; url = "$PublicSite/sandbox_external_draft_distribution_readiness_review_summary_20260611.json"; json = $true; must = "completed_sandbox_external_draft_distribution_readiness_review" },
    ...
    @{ name = "mcp_tool_manifest"; url = "$PublicSite/mcp-tool-manifest.json"; json = $true; must = "sandbox_external_draft_distribution_readiness_review_json" },
    @{ name = "well_known_mcp_tool_manifest"; url = "$PublicSite/.well-known/mcp-tool-manifest.json"; json = $true; must = "sandbox_external_draft_distribution_readiness_review_json" },
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "sandbox_external_draft_distribution_readiness_review_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Private External Evaluator Access Simulated NoWrite JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Private-external-evaluator-access-simulated-nowrite-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "private_external_evaluator_access_simulated_nowrite_summary_20260611.json" },
    ...
    @{ name = "machine_onboarding"; url = "$PublicSite/machine-onboarding.json"; json = $true; must = "completed_sandbox_external_draft_distribution_readiness_review" }
)
