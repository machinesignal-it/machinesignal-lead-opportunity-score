...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "mcp_tool_registry_draft_checklist_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "MCP Tool Registry Draft Checklist JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "MCP-tool-registry-draft-checklist-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "mcp_tool_registry_draft_checklist_20260607.json" },
