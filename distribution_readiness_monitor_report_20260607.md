...
| sandbox_only_external_publication_pack_json | 200 | True | 56581 |
...
| mcp_tool_registry_draft_checklist_json | 200 | True | 55658 |
...
| external_submission_pack_nowrite_review_json | 200 | True | 139329 |
| external_draft_submission_bundle_md | 200 | n/a | 5818 |
| external_draft_submission_bundle_json | 200 | True | 52602 |
...
| mcp_tool_registry_private_draft_pack_json | 200 | True | 57203 |
...
| mcp_purchase_decision_probe_md | 200 | n/a | 5275 |
...
| mcp_positive_verification_deep_analysis_probe_md | 200 | n/a | 3392 |
...
| machine_distribution_readiness_nowrite_probe_md | 200 | n/a | 9194 |
| machine_distribution_readiness_nowrite_probe_json | 200 | True | 17633 |
| machine_channel_rehearsal_nowrite_probe_md | 200 | n/a | 7701 |
...
| postman_private_team_workspace_sandbox_rehearsal_md | 200 | n/a | 2443 |
| postman_private_team_workspace_sandbox_rehearsal_json | 200 | True | 182069 |
| api_directory_private_listing_sandbox_rehearsal_md | 200 | n/a | 2204 |
...
| sandbox_external_draft_distribution_readiness_review_md | 200 | n/a | 2488 |
| sandbox_external_draft_distribution_readiness_review_json | 200 | True | 17687 |
...
| marketplace_submission_pack | 200 | True | 104010 |
...
| sandbox_only_external_publication_pack_json_reachable | OK | HTTP 200, bytes=56581 |
...
| external_sandbox_publication_drafts_json_reachable | OK | HTTP 200, bytes=57583 |
...
| mcp_tool_registry_draft_checklist_json_reachable | OK | HTTP 200, bytes=55658 |
...
| external_submission_pack_nowrite_review_json_reachable | OK | HTTP 200, bytes=139329 |
...
| external_draft_submission_bundle_json_reachable | OK | HTTP 200, bytes=52602 |
...
| private_draft_submission_rehearsal_json_reachable | OK | HTTP 200, bytes=56658 |
...
| mcp_tool_registry_private_draft_pack_json_reachable | OK | HTTP 200, bytes=57203 |
...
| mcp_purchase_decision_probe_md_reachable | OK | HTTP 200, bytes=5275 |
| mcp_purchase_decision_probe_md_contains_expected_marker | OK | marker=MCP Purchase Decision Probe |
| mcp_purchase_decision_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| mcp_purchase_decision_probe_json_reachable | OK | HTTP 200, bytes=8169 |
| mcp_purchase_decision_probe_json_json_valid | OK | json_valid=True |
| mcp_purchase_decision_probe_json_contains_expected_marker | OK | marker=completed_mcp_purchase_decision_probe |
| mcp_purchase_decision_probe_json_secret_scan | OK | public content has no secret-like token patterns |
| mcp_verification_gate_probe_md_reachable | OK | HTTP 200, bytes=4514 |
| mcp_verification_gate_probe_md_contains_expected_marker | OK | marker=MCP Verification Gate Probe |
| mcp_verification_gate_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| mcp_verification_gate_probe_json_reachable | OK | HTTP 200, bytes=7372 |
...
| mcp_positive_verification_deep_analysis_probe_md_reachable | OK | HTTP 200, bytes=3392 |
| mcp_positive_verification_deep_analysis_probe_md_contains_expected_marker | OK | marker=MCP Positive Verification Deep Analysis Probe |
| mcp_positive_verification_deep_analysis_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| mcp_positive_verification_deep_analysis_probe_json_reachable | OK | HTTP 200, bytes=5714 |
| mcp_positive_verification_deep_analysis_probe_json_json_valid | OK | json_valid=True |
| mcp_positive_verification_deep_analysis_probe_json_contains_expected_marker | OK | marker=completed_mcp_positive_verification_deep_analysis_probe |
| mcp_positive_verification_deep_analysis_probe_json_secret_scan | OK | public content has no secret-like token patterns |
| mcp_action_pack_deep_analysis_gate_probe_md_reachable | OK | HTTP 200, bytes=3500 |
| mcp_action_pack_deep_analysis_gate_probe_md_contains_expected_marker | OK | marker=MCP Action Pack Deep Analysis Gate Probe |
| mcp_action_pack_deep_analysis_gate_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| mcp_action_pack_deep_analysis_gate_probe_json_reachable | OK | HTTP 200, bytes=6070 |
...
| machine_distribution_readiness_nowrite_probe_md_reachable | OK | HTTP 200, bytes=9194 |
| machine_distribution_readiness_nowrite_probe_md_contains_expected_marker | OK | marker=Machine Distribution Readiness NoWrite Probe |
| machine_distribution_readiness_nowrite_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| machine_distribution_readiness_nowrite_probe_json_reachable | OK | HTTP 200, bytes=17633 |
| machine_distribution_readiness_nowrite_probe_json_json_valid | OK | json_valid=True |
| machine_distribution_readiness_nowrite_probe_json_contains_expected_marker | OK | marker=completed_machine_distribution_readiness_nowrite_probe |
| machine_distribution_readiness_nowrite_probe_json_secret_scan | OK | public content has no secret-like token patterns |
| machine_channel_rehearsal_nowrite_probe_md_reachable | OK | HTTP 200, bytes=7701 |
| machine_channel_rehearsal_nowrite_probe_md_contains_expected_marker | OK | marker=MachineSignal - Channel Publication Rehearsal NoWrite Probe |
| machine_channel_rehearsal_nowrite_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| machine_channel_rehearsal_nowrite_probe_json_reachable | OK | HTTP 200, bytes=15559 |
| machine_channel_rehearsal_nowrite_probe_json_json_valid | OK | json_valid=True |
| machine_channel_rehearsal_nowrite_probe_json_contains_expected_marker | OK | marker=completed_machine_channel_rehearsal_nowrite_probe |
| machine_channel_rehearsal_nowrite_probe_json_secret_scan | OK | public content has no secret-like token patterns |
| postman_private_workspace_rehearsal_nowrite_probe_md_reachable | OK | HTTP 200, bytes=8132 |
| postman_private_workspace_rehearsal_nowrite_probe_md_contains_expected_marker | OK | marker=Postman Private Workspace Rehearsal NoWrite Probe |
| postman_private_workspace_rehearsal_nowrite_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| postman_private_workspace_rehearsal_nowrite_probe_json_reachable | OK | HTTP 200, bytes=12985 |
...
| postman_private_team_workspace_sandbox_rehearsal_md_reachable | OK | HTTP 200, bytes=2443 |
| postman_private_team_workspace_sandbox_rehearsal_md_contains_expected_marker | OK | marker=Postman Private Team Workspace Sandbox Rehearsal |
| postman_private_team_workspace_sandbox_rehearsal_md_secret_scan | OK | public content has no secret-like token patterns |
| postman_private_team_workspace_sandbox_rehearsal_json_reachable | OK | HTTP 200, bytes=182069 |
| postman_private_team_workspace_sandbox_rehearsal_json_json_valid | OK | json_valid=True |
| postman_private_team_workspace_sandbox_rehearsal_json_contains_expected_marker | OK | marker=completed_postman_private_team_workspace_sandbox_rehearsal |
| postman_private_team_workspace_sandbox_rehearsal_json_secret_scan | OK | public content has no secret-like token patterns |
| api_directory_private_listing_sandbox_rehearsal_md_reachable | OK | HTTP 200, bytes=2204 |
| api_directory_private_listing_sandbox_rehearsal_md_contains_expected_marker | OK | marker=API Directory Private Listing Sandbox Rehearsal |
| api_directory_private_listing_sandbox_rehearsal_md_secret_scan | OK | public content has no secret-like token patterns |
| api_directory_private_listing_sandbox_rehearsal_json_reachable | OK | HTTP 200, bytes=13403 |
| api_directory_private_listing_sandbox_rehearsal_json_json_valid | OK | json_valid=True |
| api_directory_private_listing_sandbox_rehearsal_json_contains_expected_marker | OK | marker=completed_api_directory_private_listing_sandbox_rehearsal |
| api_directory_private_listing_sandbox_rehearsal_json_secret_scan | OK | public content has no secret-like token patterns |
...
| mcp_agent_registry_draft_rehearsal_nowrite_probe_md_reachable | OK | HTTP 200, bytes=5365 |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_md_contains_expected_marker | OK | marker=MCP Agent Registry Draft Rehearsal NoWrite Probe |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_md_secret_scan | OK | public content has no secret-like token patterns |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_json_reachable | OK | HTTP 200, bytes=39321 |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_json_json_valid | OK | json_valid=True |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_json_contains_expected_marker | OK | marker=completed_mcp_agent_registry_draft_rehearsal_nowrite |
| mcp_agent_registry_draft_rehearsal_nowrite_probe_json_secret_scan | OK | public content has no secret-like token patterns |
| machine_buyer_end_to_end_rehearsal_md_reachable | OK | HTTP 200, bytes=1911 |
| machine_buyer_end_to_end_rehearsal_md_contains_expected_marker | OK | marker=Machine Buyer End-to-End Rehearsal |
| machine_buyer_end_to_end_rehearsal_md_secret_scan | OK | public content has no secret-like token patterns |
| machine_buyer_end_to_end_rehearsal_json_reachable | OK | HTTP 200, bytes=261640 |
...
| sandbox_external_draft_distribution_readiness_review_md_reachable | OK | HTTP 200, bytes=2488 |
| sandbox_external_draft_distribution_readiness_review_md_contains_expected_marker | OK | marker=MachineSignal Sandbox External Draft Distribution Readiness Review |
| sandbox_external_draft_distribution_readiness_review_md_secret_scan | OK | public content has no secret-like token patterns |
| sandbox_external_draft_distribution_readiness_review_json_reachable | OK | HTTP 200, bytes=17687 |
| sandbox_external_draft_distribution_readiness_review_json_json_valid | OK | json_valid=True |
| sandbox_external_draft_distribution_readiness_review_json_contains_expected_marker | OK | marker=completed_sandbox_external_draft_distribution_readiness_review |
| sandbox_external_draft_distribution_readiness_review_json_secret_scan | OK | public content has no secret-like token patterns |
...
| marketplace_api_directory_pack_json_reachable | OK | HTTP 200, bytes=63247 |
...
| marketplace_publication_execution_pack_json_reachable | OK | HTTP 200, bytes=57816 |
...
| marketplace_submission_pack_reachable | OK | HTTP 200, bytes=104010 |
...
| postman_workspace_draft_reachable | OK | HTTP 200, bytes=16661 |
...
| mcp_tool_manifest_reachable | OK | HTTP 200, bytes=130283 |
| mcp_tool_manifest_json_valid | OK | json_valid=True |
| mcp_tool_manifest_contains_expected_marker | OK | marker=sandbox_external_draft_distribution_readiness_review_json |
| mcp_tool_manifest_secret_scan | OK | public content has no secret-like token patterns |
| well_known_mcp_tool_manifest_reachable | OK | HTTP 200, bytes=130283 |
| well_known_mcp_tool_manifest_json_valid | OK | json_valid=True |
| well_known_mcp_tool_manifest_contains_expected_marker | OK | marker=sandbox_external_draft_distribution_readiness_review_json |
| well_known_mcp_tool_manifest_secret_scan | OK | public content has no secret-like token patterns |
| well_known_machine_discovery_reachable | OK | HTTP 200, bytes=113885 |
...
| llms_reachable | OK | HTTP 200, bytes=35258 |
| llms_contains_expected_marker | OK | marker=API Directory Private Listing Sandbox Rehearsal JSON |
| llms_secret_scan | OK | public content has no secret-like token patterns |
| robots_reachable | OK | HTTP 200, bytes=15229 |
| robots_contains_expected_marker | OK | marker=Api-directory-private-listing-sandbox-rehearsal-json |
| robots_secret_scan | OK | public content has no secret-like token patterns |
| sitemap_reachable | OK | HTTP 200, bytes=22216 |
| sitemap_contains_expected_marker | OK | marker=api_directory_private_listing_sandbox_rehearsal_summary_20260611.json |
...
| openapi_contains_expected_marker | OK | marker=action_pack_gate_failed |
| openapi_secret_scan | OK | public content has no secret-like token patterns |
| postman_public_collection_reachable | OK | HTTP 200, bytes=27564 |
...
| machine_onboarding_reachable | OK | HTTP 200, bytes=137138 |
| machine_onboarding_json_valid | OK | json_valid=True |
| machine_onboarding_contains_expected_marker | OK | marker=completed_sandbox_external_draft_distribution_readiness_review |
