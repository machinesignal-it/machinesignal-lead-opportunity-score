...
| agent_go_no_go_postman_api_directory_review_md_reachable | OK | HTTP 200, bytes=5257 |
| agent_go_no_go_postman_api_directory_review_md_contains_expected_marker | OK | marker=MachineSignal Agent Go/No-Go Postman and API Directory Review |
| agent_go_no_go_postman_api_directory_review_md_secret_scan | OK | public content has no secret-like token patterns |
| agent_go_no_go_postman_api_directory_review_json_reachable | OK | HTTP 200, bytes=3819 |
