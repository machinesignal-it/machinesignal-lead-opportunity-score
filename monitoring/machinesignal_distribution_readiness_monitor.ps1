...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "RapidAPI-Style Unpublished Provider Sandbox Rehearsal JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Rapidapi-unpublished-provider-sandbox-rehearsal-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "rapidapi_unpublished_provider_sandbox_rehearsal_summary_20260611.json" },
