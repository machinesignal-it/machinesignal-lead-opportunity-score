...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Agent Go/No-Go Postman and API Directory Review JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Agent-go-no-go-postman-api-directory-review-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "agent_go_no_go_postman_api_directory_review_summary_20260611.json" },
