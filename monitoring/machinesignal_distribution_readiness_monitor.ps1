...
$resources = @(
    ...
    @{ name = "mcp_tool_manifest"; url = "$PublicSite/mcp-tool-manifest.json"; json = $true; must = "get_api_directory_private_draft_review" },
    @{ name = "well_known_mcp_tool_manifest"; url = "$PublicSite/.well-known/mcp-tool-manifest.json"; json = $true; must = "get_api_directory_private_draft_review" },
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "api_directory_private_draft_review_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "API Directory Private Draft Review JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Api-directory-private-draft-review-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "api_directory_private_draft_review_summary_20260608.json" },
