...
$resources = @(
    ...
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "postman_private_workspace_rehearsal_nowrite_probe_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Postman Private Workspace Rehearsal NoWrite Probe JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Postman-private-workspace-rehearsal-nowrite-probe-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "postman_private_workspace_rehearsal_nowrite_probe_summary_20260611.json" },
