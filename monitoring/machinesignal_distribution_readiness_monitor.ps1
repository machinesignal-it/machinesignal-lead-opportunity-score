...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "External Sandbox Publication Drafts JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "External-sandbox-publication-drafts-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "external_sandbox_publication_drafts_20260607.json" },
