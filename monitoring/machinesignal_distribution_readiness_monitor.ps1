...
$resources = @(
    ...
    @{ name = "mcp_tool_manifest"; url = "$PublicSite/mcp-tool-manifest.json"; json = $true; must = "get_external_draft_submission_bundle" },
    @{ name = "well_known_mcp_tool_manifest"; url = "$PublicSite/.well-known/mcp-tool-manifest.json"; json = $true; must = "get_external_draft_submission_bundle" },
    @{ name = "well_known_machine_discovery"; url = "$PublicSite/.well-known/machine-discovery.json"; json = $true; must = "external_draft_submission_bundle_json" },
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "External Draft Submission Bundle JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "External-draft-submission-bundle-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "external_draft_submission_bundle_20260608.json" },
