...
$resources = @(
    ...
    @{ name = "llms"; url = "$PublicSite/llms.txt"; json = $false; must = "Postman Private Workspace Checklist JSON" },
    @{ name = "robots"; url = "$PublicSite/robots.txt"; json = $false; must = "Postman-private-workspace-checklist-json" },
    @{ name = "sitemap"; url = "$PublicSite/sitemap.xml"; json = $false; must = "postman_private_workspace_checklist_20260607.json" },
