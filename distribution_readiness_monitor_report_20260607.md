...
|---|---:|---|---:|
| distribution_index | 200 | n/a | 16668 |
...
| sandbox_only_external_publication_pack_json | 200 | True | 17658 |
| external_sandbox_publication_drafts_md | 200 | n/a | 7076 |
| external_sandbox_publication_drafts_json | 200 | True | 18183 |
...
| external_submission_pack_nowrite_review_md | 200 | n/a | 3943 |
| external_submission_pack_nowrite_review_json | 200 | True | 33276 |
| external_draft_submission_bundle_md | 200 | n/a | 5818 |
| external_draft_submission_bundle_json | 200 | True | 13541 |
| private_draft_submission_rehearsal_md | 200 | n/a | 3067 |
| private_draft_submission_rehearsal_json | 200 | True | 14202 |
| marketplace_api_directory_pack_md | 200 | n/a | 13583 |
| marketplace_api_directory_pack_json | 200 | True | 25678 |
| marketplace_publication_execution_pack_md | 200 | n/a | 14318 |
| marketplace_publication_execution_pack_json | 200 | True | 22795 |
| api_directory_submission | 200 | True | 8667 |
| rapidapi_listing | 200 | True | 11250 |
| marketplace_submission_pack | 200 | True | 25431 |
...
| mcp_tool_manifest | 200 | True | 36562 |
| well_known_mcp_tool_manifest | 200 | True | 36562 |
| well_known_machine_discovery | 200 | True | 23109 |
| llms | 200 | n/a | 19198 |
| robots | 200 | n/a | 8573 |
| sitemap | 200 | n/a | 16158 |
| openapi | 200 | True | 58945 |
| postman_public_collection | 200 | True | 27401 |
| product_catalog | 200 | True | 12370 |
| machine_onboarding | 200 | True | 45740 |

## Checks

| Check | Status | Details |
|---|---|---|
| distribution_index_reachable | OK | HTTP 200, bytes=16668 |
...
| sandbox_only_external_publication_pack_json_reachable | OK | HTTP 200, bytes=17658 |
...
| external_sandbox_publication_drafts_json_reachable | OK | HTTP 200, bytes=18183 |
...
| external_submission_pack_nowrite_review_md_reachable | OK | HTTP 200, bytes=3943 |
...
| external_submission_pack_nowrite_review_json_reachable | OK | HTTP 200, bytes=33276 |
...
| external_draft_submission_bundle_json_reachable | OK | HTTP 200, bytes=13541 |
...
| marketplace_api_directory_pack_md_reachable | OK | HTTP 200, bytes=13583 |
...
| marketplace_api_directory_pack_json_reachable | OK | HTTP 200, bytes=25678 |
...
| marketplace_publication_execution_pack_json_reachable | OK | HTTP 200, bytes=22795 |
...
| marketplace_submission_pack_reachable | OK | HTTP 200, bytes=25431 |
...
| mcp_tool_manifest_reachable | OK | HTTP 200, bytes=36562 |
| mcp_tool_manifest_json_valid | OK | json_valid=True |
| mcp_tool_manifest_contains_expected_marker | OK | marker=get_private_draft_submission_rehearsal |
| mcp_tool_manifest_secret_scan | OK | public content has no secret-like token patterns |
| well_known_mcp_tool_manifest_reachable | OK | HTTP 200, bytes=36562 |
| well_known_mcp_tool_manifest_json_valid | OK | json_valid=True |
| well_known_mcp_tool_manifest_contains_expected_marker | OK | marker=get_private_draft_submission_rehearsal |
| well_known_mcp_tool_manifest_secret_scan | OK | public content has no secret-like token patterns |
| well_known_machine_discovery_reachable | OK | HTTP 200, bytes=23109 |
| well_known_machine_discovery_json_valid | OK | json_valid=True |
| well_known_machine_discovery_contains_expected_marker | OK | marker=private_draft_submission_rehearsal_json |
| well_known_machine_discovery_secret_scan | OK | public content has no secret-like token patterns |
| llms_reachable | OK | HTTP 200, bytes=19198 |
| llms_contains_expected_marker | OK | marker=Private Draft Submission Rehearsal JSON |
| llms_secret_scan | OK | public content has no secret-like token patterns |
| robots_reachable | OK | HTTP 200, bytes=8573 |
| robots_contains_expected_marker | OK | marker=Private-draft-submission-rehearsal-json |
| robots_secret_scan | OK | public content has no secret-like token patterns |
| sitemap_reachable | OK | HTTP 200, bytes=16158 |
| sitemap_contains_expected_marker | OK | marker=private_draft_submission_rehearsal_summary_20260608.json |
...
| machine_onboarding_reachable | OK | HTTP 200, bytes=45740 |
