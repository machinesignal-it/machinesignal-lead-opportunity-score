...
const OUTPUT_REPORT =
  "private-evaluator-pack/soft_go_live_sandbox_only_rehearsal_report_20260613.md";
const OUTPUT_SUMMARY =
  "private-evaluator-pack/soft_go_live_sandbox_only_rehearsal_summary_20260613.json";
...
async function run() {
  ...
  const summary = {
    ...
    probe_name: "soft_go_live_sandbox_only_rehearsal",
    status: failed.length === 0
      ? "completed_soft_go_live_sandbox_only_rehearsal"
      : "failed_soft_go_live_sandbox_only_rehearsal",
    ok: failed.length === 0,
  ...
  const report = `# MachineSignal - Soft Go-Live Sandbox-Only Rehearsal - 2026-06-13
